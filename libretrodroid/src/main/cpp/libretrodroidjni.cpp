...
Java_com_swordfish_libretrodroid_LibretroDroid_getHwContextType(JNIEnv *env, jclass clazz) {
    return Environment::getInstance().getHwContextType();
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_swordfish_libretrodroid_LibretroDroid_getHwVersionMajor(JNIEnv *env, jclass clazz) {
    return Environment::getInstance().getHwVersionMajor();
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_swordfish_libretrodroid_LibretroDroid_getHwVersionMinor(JNIEnv *env, jclass clazz) {
    return Environment::getInstance().getHwVersionMinor();
}
